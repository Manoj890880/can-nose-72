...
public class CriminalDAOImpl implements CriminalDAO{
	...
	public List<Criminal> getCriminalByName(String name) throws SomeThingWrongException, NoRecordFoundException {
		...
		try {
			...
			String SELECT_QUERY = "SELECT * FROM Criminal WHERE name = ?";
	...
	@Override
	public List<Criminal> getCriminalByArea(String address) throws SomeThingWrongException, NoRecordFoundException {
