...
//		return "  " + id + "   " + date + "   " + place + "" + crimeType + ""
//				+ victims + "" + details + "" + suspectedNames + "" + status
//				+ "" + ipcSection + "";
		
		
		
		// return ""+ id   +"|" date       +"|" place      | crimeType | victims          | details                  | suspectedNames| status | ipcSection;
		return id + "    |" + date + "  |" + place + "    |" + crimeType + "   |" + victims + "     |" +
        details + "      |" + suspectedNames + "     |" + status + "     1|" + ipcSection;
	}
